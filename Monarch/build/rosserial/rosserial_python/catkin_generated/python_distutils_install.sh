...
echo_and_run cd "/home/oduasv/Monarch/src/rosserial/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/oduasv/Monarch/src/rosserial/rosserial_python/setup.py" \
    build --build-base "/home/oduasv/Monarch/build/rosserial/rosserial_python" \
    install \
    $DESTDIR_ARG \
